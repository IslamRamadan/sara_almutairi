            ...
            <div class="row pad  dir-rtl">
                <div class="col-12 col-lg-8 ">
                    <div class=" border text-dir ">
                        ...
                        <br>
                        <div class="row mr-0">
                            <form class="form-vertical col-md-12 col-xs-12 " id="orders-form" action="{{route('order.store')}}"
                                  method="post">
                               ...
                               -->
                                ...
                                @guest()
                                    ...
                                    <div class="form-group">
                                        <label for="Orders_address_line1" class="required font-weight-bold" style="color:red"> @lang('site.full_name')
                                    ...
                                    <div class="form-group">
                                        <label for="Orders_address_line1" class="required font-weight-bold" style="color:red"> @lang('site.email') <span
                                        ...
                                        <div class="form-group">
                                            <label for="Orders_address_line1" class="required font-weight-bold" style="color:red">@lang('site.phone')
                                            ...
                                            <input id="phone_code"
                                                   ...
                                                   value="{{old('phone')}}"
                                                   type="number" maxlength="11"></div>
                                    <div class="form-group">
                                        <label for="Orders_country_id" class="required font-weight-bold" style="color:red">@lang('site.country') <span
                                                class="required">*</span></label>
                                        <select style="height: 45px;    ;"
                                                class="form-control" name="country_id"
                                                value="{{old('country_id')}}"
                                                id="Orders_country_id">
                                    ...
                                    <div class="form-group">
                                        <label for="Orders_city_id" class="required font-weight-bold" style="color:red"> @lang('site.region') <span
                                                class="required">*</span></label>
                                        <select style="height: 45px; " class="form-control"
                                                name="city_id" id="Orders_city_id"
                                              >
                                        </select>
                                    </div>
                                    ...
                                    <input type="hidden"  id="Orders_country_id" name="country_id" value="{{Auth::user()->country_id}}">
                                    ...
                                    {{--<div class="form-group" >--}}
                                        {{--<label for="Orders_postal_code" class="required" style="color:red">@lang('site.postal_code')<span--}}
                                                {{--class="required">*</span></label>--}}
                                        <input class="form-control" placeholder="" name="postal_code"
                                               id="Orders_postal_code"
                                               value="0"
                                               type="hidden">
...
{{--                                           type="text" maxlength="100"></div>--}}
                                ...
                                <div class="form-group">
                                    <label for="Orders_address_line1" class="required font-weight-bold" style="color:red"><span
                                            class="required">*</span>@lang('site.add_1')</label>
                                    <input class="form-control" placeholder="" name="address1"
                                           id="Orders_address_line1"
                                           value="{{old('address1')}}"
...
{{--                                       type="hidden">--}}
                                <div class="form-actions">
                                    <button class="btn btn-third-col bg-b" type="submit">@lang('site.complete_purshase')</button>
                            ...
                            <div class="col-12 col-lg-4 ">
                                            ...
                                            <div class="row border-bottom mr-0 p-3">
                                                ...
                                                <div class="col-9">
                                                    ...
                                                    <p class="font-weight-bold" >
                                                        ...
                                                        : {{$cart_child['quantity']}}
                                                        <br>
                                                        @lang('site.size'): {{ \App\ProdSize::find($cart_child['product_size_id'])->size['name']}}
                                                        <br>
                                ...
                                <span class="font-weight-bold">
                                    ...
                                    :
                                                    ...
                                                    <span> {{Session::get('cart_details')['totalQty']}}</span></p>
